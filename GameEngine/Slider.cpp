...
namespace GameEngine {
	...
	void Slider::init(float x, float y, float width, float height, float lineWidth, float lineHeight, float depth, float percent, std::string texPath, std::string aniPath,
